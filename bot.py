...
async def on_message(message):
    ...
    elif message.content.startswith('$') and message.content != '$date' and message.content != '$time' and message.content != '$toss' !message.content.startswith('bye') !message.content.startswith('happy birthday'):
